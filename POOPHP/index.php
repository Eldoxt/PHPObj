...
$articles = $articlesManager->getArticlesById(1);
print_r2($articles);


// Récup liste articles

$articlesManager = new articlesManager($bdd);
$listArticles = $articlesManager->getListArticles();
        ...
        <div class="col">
          <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <h1 class="fw-light"><?=$art->getTITRE()?></h1>
              <p class="card-text"><?=$art->getTEXTE()?></p>


              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary"><?=$art->getDATE()?></button>
